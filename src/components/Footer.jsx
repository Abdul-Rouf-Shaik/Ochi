...
function Footer() {
  return (
    <div className=" flex justify-between px-14 py-14 w-full h-screen bg-zinc-900 font-founders">
      <div className="w-1/2 h-full flex flex-col justify-between">
        <div className="heading">
          <h1 className="text-[8.7vw] leading-none">EYE-</h1>
          <h1 className="text-[8.7vw] leading-none">OPENING</h1>
        </div>
        <div className="">
          <svg
            width="72"
      ...
      <div className="w-1/2 h-full">
        <h1 className="text-[8.7vw] leading-none">PRESENTATIONS</h1>
        <div className="links font-nueue flex flex-col gap-5 mt-10 underline">
            <a href="">Instagram</a>
            <a href="">Behance</a>
            <a href="">Facebook</a>
            <a href="">Linkedin</a>
